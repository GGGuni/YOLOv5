...
target_layers_list = [[model.model[17]], [model.model[20]], [model.model[23]]]
...
for img_path in img_list:
    ...
    for lc, target_layers in enumerate(target_layers_list):
        ...
        cv2.imwrite("./cam_vis/"+img_path+"_"+str(lc)+".jpg", np.hstack((rgb_img[...,::-1], cam_image, renormalized_cam_image)))
